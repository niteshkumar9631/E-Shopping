  ...
  return (
    <div>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            <img src={assets.nitesh_logo} className='mb-5 w-32' alt="" />
        ...
        <div>
            ...
            <ul className='flex flex-col gap-1 text-gray-600'>
                <li>+91 9631742655</li>
                <li>niteshkumar42655@gmail.com</li>
        ...
        <div>
            <hr />
            <p className='py-5 text-sm text-center'> Copyright 2025@ nitesh.com-All Right Reserved.</p>
        </div>
