...
const List = ({ token }) => {
  ...
  const handleEdit = (id) => {
    navigate(`/edit-product/${id}`); // navigate to EditProduct page
  }
            ...
            <div key={index} className='grid grid-cols-[1fr_3fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-3 py-2 px-3 border-b bg-white hover:bg-gray-100 transition-all duration-200 last:border-none'>
              ...
              <div className='flex gap-2 justify-center'>
                <button
                  ...
                  className='bg-blue-100 hover:bg-blue-200 text-blue-600 px-3 py-1 rounded-md transition-all duration-200'
                >
                  Edit
                </button>
                <button
